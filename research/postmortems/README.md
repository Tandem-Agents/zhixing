...
| 2026-08-06 | [零功能缺陷下的最终验证耗时失控](2026-08-06-final-validation-overrun.md) | 未预算全包闭包成本、昂贵命令无可恢复结果后换参数重复运行，零功能修复仍耗时超过一小时 | 冻结前计算验证总账；首次运行必须可恢复；同范围无新增信息立即停止；进度只按可核对闭包计算 |
