...
>   - llm-summarization.md（历史文档，已退役） — 7 段结构 / prompt / 校验同步更新到代码现状
>   - [thinking-control.md](specifications/thinking-control.md) / [工作场景架构](../../docs/modules/workscene/architecture.md) / [subagent-execution.md](specifications/subagent-execution.md) — 引用同步
