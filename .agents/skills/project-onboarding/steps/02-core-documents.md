...
7. 阅读“屏幕渲染 (Screen Rendering)”文档，路径是 `research/internals/screen-rendering/overview.md`。
8. 整理这些文档之间的关系，只输出对后续工作最有用的核心理解和仍需确认的问题。
9. 这是终止 step；完成当前输出后停止。
...
- 项目整体定位；
- 核心模块和接入面；
- 对话持久化、注意力窗口、文件化编排、生命周期、任务推进闭环和屏幕渲染之间的关系；
- 后续开发或审查时最需要注意的约束；
- 仍不确定的信息。
