...
const STREAM_PATTERN =
  /^(?:control|publish|governor|final-outbox|trust|exposure|delivery|pairing|checkpoint|device-lifecycle|extensions|(?:run|job|transfer|intent|assignment|executor|session-activity):[^\u0000-\u001f\u007f]{1,480})$/u;
